    ...
    public class AccountController : Controller
    {
        ...
        private void CreateAdminIfNeeded()
        {
            ...
            if (objAdminUser == null)
            {
                ...
                {
                    // Create the Agent Role (if needed)
                    IdentityRole objAdminRole = new IdentityRole("Agent");
                    RoleManager.Create(objAdminRole);
                          
                }
                // Create Agent user
                var objNewAgentUser = new ApplicationUser { UserName = AdminUserName, Email = AdminUserName };
                var AgentUserCreateResult = UserManager.Create(objNewAdminUser, AdminPassword);
                // Put user in Agent role
                UserManager.AddToRole(objNewAdminUser.Id, "Agent");
